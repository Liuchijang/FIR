...
func init() { collector.Register(&processExplorerCollector{}) }
...
func (c *processExplorerCollector) Collect(ctx context.Context, outputDir string) ([]collector.FileInfo, error) {
